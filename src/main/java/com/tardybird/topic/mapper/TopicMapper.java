...
public interface TopicMapper {
     ...
     * @return a topic
     */
    @Select("select gmt_create,gmt_modified,is_deleted,pic_url_list,content " +
    ...
    @Results(id = "topic", value = {
            ...
            @Result(property = "beDeleted", column = "is_deleted", javaType = Integer.class),
     ...
     */
    @Update("update topic(gmt_create,gmt_modified,is_deleted,is_deleted,pic_url_list,content)" +
